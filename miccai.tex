...
However, it did not address the issue of fine-grained classification between ASD/FXS and other disorders in an automated way. Our work extends this to develop a means for FXS classification via multi-modal data.%} \textcolor{red}{Rubbish: say something about sharing the essence of automatic assessment through ubiquitous vision, but is non overlapping.}
%\vspace{-1em} 
%\vspace*{-\baselineskip}
...
\section{Dataset}
\vspace{-1.5em} 
Our raw data are 70 videos of an experimenter interviewing a participant, overlaid with the participant's point of gaze (as measure by a remote eye-tracker).% \textcolor{red}{Explain that raw eye-tracking has no value without knowing what the visual fixation's target is. Cite Scott's paper}
\vspace*{-\baselineskip}
...
\vspace{-1 em}
We next present a number of descriptive analyses of the dataset that explore the complexity of this rich data.% and justify the importance of using 
\vspace{-1 em}
...
\begin{figure} [t]
          %\subfigure[ DD]{
            % \includegraphics[width=0.6in,height= 0.7in]{figures/semdd.png}
            % } 
             %  \hfill   
           % \subfigure[FXS-F]{
           % \includegraphics[width=0.6in,height= 0.7in]{figures/semfemale.png} 
          %  }
           %    \hfill
          %   \subfigure[FXS-M]{
         %   \includegraphics[width=0.7in,height= 0.7in]{figures/semmale.png} 
        %    }
          %  \hfill
          \subfigure[DD]{
...
\end{figure}
%FXS females exhibit similar sparsity amongst some individuals and much more consistent face-glancing amongst others.
