...
%%%%%%%%% TITLE
\title{Vision-based classification of developmental disorders via temporal structure in eye-movements}
...
\begin{figure}[ht]   
\centering
\includegraphics[width=0.5\textwidth]{figures/Pull.png}
