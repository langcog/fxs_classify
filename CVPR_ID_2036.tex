...
\begin{figure}[ht]   
\includegraphics[width=0.45\textwidth]{Pull.png}
...
\begin{figure}[ht]   
 \centering
           \includegraphics[width=2in,height= 1.5in]{Real.png}
...
\begin{figure}
          \subfigure[]{
             \includegraphics[width=0.6in,height=0.7in]{CVIM/movement1.png}
             } 
                  \hfill   
            \subfigure[]{
            \includegraphics[width=0.6in,height= 0.7in]{CVIM/movement2.png} 
            }
                 \hfill
             \subfigure[]{
            \includegraphics[width=0.6in,height= 0.7in]{CVIM/margin.png} 
            }
                 \hfill
             \subfigure[]{
            \includegraphics[width=0.6in,height= 0.7in]{CVIM/margin2.png} 
            }
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.5\linewidth]{face2.png}
    \end{center}
...
\begin{figure}%[t]
          \subfigure[ DD]{
             \includegraphics[width=1in,height= 0.7in]{CVIM/semdd.png}
             } 
               \hfill   
            \subfigure[FXS-F]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/semfemale.png} 
            }
               \hfill
             \subfigure[FXS-M]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/semmale.png} 
            }
          \subfigure[DD]{
             \includegraphics[width=1in,height= 0.7in]{CVIM/semdd-face.png}
             } 
               \hfill   
            \subfigure[FXS-F]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/semfemale-face.png} 
            }
               \hfill
             \subfigure[FXS-M]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/semmale-face.png} 
            }
...
\begin{figure}[b]
          \subfigure[DD]{
             \includegraphics[width=1in,height= 0.7in]{CVIM/transdd.png}
             } 
               \hfill   
            \subfigure[FXS-F]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/transfemale.png} 
            }
               \hfill
             \subfigure[FXS-M]{
            \includegraphics[width=1in,height= 0.7in]{CVIM/transmale.png} 
            }            
...
\begin{figure}
       ...
       \subfigure[DD - Group]{
             \includegraphics[width=0.22\textwidth]{DD-face.png}
            }
            \hfill
          \subfigure[FXS Female]{
             \includegraphics[width=0.22\textwidth]{FXSF-face.png}
            }
            \hfill
            \centering
              \subfigure[FXS Male]{
             \includegraphics[width=0.22\textwidth]{FXSM-face.png}
            }
...
\begin{figure}
        \subfigure[Tolerance Parameter]{
             \includegraphics[width=0.2\textwidth]{entropy-r.png}
        }
            \hfill
        \subfigure[Dimension]{
             \includegraphics[width=0.2\textwidth]{entropy-w.png}      }
...
\begin{figure}[b]
        \centering
        \subfigure[DD]{
             \includegraphics[width=0.2\textwidth]{DDen}
        }
            \hfill
        \subfigure[FXS-F]{
             \includegraphics[width=0.2\textwidth]{FXFen}      }
             \hfill
         \centering
         \subfigure[FXS-M]{
             \includegraphics[width=0.2\textwidth]{FXMen}}
...
\begin{figure}[h]
        ...
        \subfigure[DD vs FXS Female]{
             \includegraphics[width=0.35\textwidth]{CVIM/Temporal-DDvsFXSfemale-SVM}
        }
            \hfill
       \subfigure[DD vs FXS Male]{
             \includegraphics[width=0.35\textwidth]{CVIM/Temporal-DDvsFXSmale-SVM.jpg}
